...
public partial class AddtoCart8 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (orderconfirm == true)
        {
            ...
            Response.Redirect("PlaceYourOrder8.aspx");
    ...
    private void updatestock(int designid, int numbersold)
    {
        ...
        con.Close();
        String mycon1 = "Data Source=DESKTOP-DRU27SS; Initial Catalog=specialshop; Integrated Security=True";
        int newavailable;
        int newsold;
        if (pavailable >= numbersold)
        {
