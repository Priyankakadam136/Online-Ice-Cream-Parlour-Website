...
public partial class AddtoCart7 : System.Web.UI.Page
{
        ...
        if (Session["addproduct"].ToString() == "true")
        {
            ...
            if (Request.QueryString["id"] != null)
            {
                if (Session["Buyitems"] == null)
                {
                    ...
                    dr = dt.NewRow();
                    String mycon = "Data Source=DESKTOP-DRU27SS;Initial Catalog=candiesshop; Integrated Security=True";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (orderconfirm == true)
        {
            ...
            Response.Redirect("PlaceYourOrder6.aspx");
    ...
    private void updatestock(int designid, int numbersold)
    {
        ...
        con.Close();
        String mycon1 = "Data Source=DESKTOP-DRU27SS; Initial Catalog=candiesshop; Integrated Security=True";
        int newavailable;
        int newsold;
        if (pavailable >= numbersold)
        {
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        Session["buyitems"] = dt;
        Response.Redirect("AddtoCart7.aspx");
    }
}
