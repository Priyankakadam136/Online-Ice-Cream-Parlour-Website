...
public partial class PlaceYourOrder1 : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["id"] != null)
            {
                if (Session["Buyitems"] == null)
                {
                    ...
                    dr = dt.NewRow();
                    String mycon = "Data Source=DESKTOP-DRU27SS;Initial Catalog=icecreamshop1;Integrated Security=True";
    ...
    public void saveaddress()
    {
        ...
        String mycon1 = "Data Source=DESKTOP-DRU27SS;Initial Catalog=ShoppingData1;Integrated Security=True";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        saveaddress();
        Response.Redirect("SuccessPage1.aspx?orderid="+Label3.Text);
    }
}