<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddtoCart5.aspx.cs" Inherits="AddtoCart5" %>
...
<body>
     ...
     <div class="auto-style1">
            ...
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" Font-Size="X-Large" ForeColor="Red" NavigateUrl="~/Default5.aspx">Continue to Order</asp:HyperLink>
            <br />
            <br />
            <br />
            ...
            <br />
            <br />
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" EmptyDataText="No Product available in the Cart.Empty Cart" ForeColor="#333333" OnRowDeleting="GridView1_RowDeleting" HorizontalAlign="Center" Height="55px" Width="775px">
