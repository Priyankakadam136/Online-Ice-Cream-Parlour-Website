...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label2" runat="server" Font-Italic="True" Font-Size="X-Large" ForeColor="#FF3300" Text="Welcome  for Ordering!!"></asp:Label>
            ...
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" Font-Size="X-Large" ForeColor="#0033CC" NavigateUrl="~/AddtoCart5.aspx">View Cart</asp:HyperLink>
            &nbsp;<br />
            <br />
      
           <asp:DataList ID="DataList1" runat="server" OnItemCommand="DataList1_ItemCommand" DataSourceID="SqlDataSource1" CellPadding="20" RepeatColumns="3" RepeatDirection="Horizontal" HorizontalAlign="Center">
                 <ItemTemplate>
...
<br />
        ...
        <br />
              <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:icecreamshop3ConnectionString2 %>" SelectCommand="SELECT * FROM [ProductDetails]"></asp:SqlDataSource>
         <br />
              </div>
