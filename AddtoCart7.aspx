<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddtoCart7.aspx.cs" Inherits="AddtoCart7" %>
...
<body>
    <form id="form1" runat="server">
          <div class="auto-style1">
            ...
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" Font-Size="X-Large" ForeColor="Red" NavigateUrl="~/Default7.aspx">Continue to Order</asp:HyperLink>
            <br />
            <br />
            <br />
