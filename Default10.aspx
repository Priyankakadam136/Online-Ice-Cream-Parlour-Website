...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label2" runat="server" Font-Italic="True" Font-Size="X-Large" ForeColor="#FF3300" Text="Welcome  for Ordering!!"></asp:Label>
            ...
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:HyperLink ID="HyperLink2" runat="server" Font-Underline="True" NavigateUrl="~/Order.aspx">Back to Menu</asp:HyperLink>
            <br />
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" Font-Size="X-Large" ForeColor="#0033CC" NavigateUrl="~/AddtoCart10.aspx">View Cart</asp:HyperLink>
            &nbsp;<br />
            <br />
            ...
            <asp:DataList ID="DataList1" runat="server" OnItemCommand="DataList1_ItemCommand" DataSourceID="SqlDataSource1" HorizontalAlign="Center" CellPadding="30" RepeatColumns="3" RepeatDirection="Horizontal" CellSpacing="10">
                <ItemTemplate>
                    <table border="0" class="auto-style2">
                        ...
                        <tr>
                            <td class="auto-style3">
                                <asp:ImageButton ID="ImageButton1" runat="server" Height="300px" ImageUrl='<%# Eval("productimage") %>' Width="280px" />
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style3">
...
<br />
               ...
               <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:familyshopConnectionString %>" SelectCommand="SELECT * FROM [ProductDetails]"></asp:SqlDataSource>
           <div style="text-align:center">
               <p style="font-family: 'Comic Sans MS'; font-size: large; font-style: italic; color: #800080">SPECIAL OFFER-BUY ANY ONE GET ONE FREE</p>
