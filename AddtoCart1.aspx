<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddtoCart1.aspx.cs" Inherits="AddtoCart1" %>
...
<body>
    <form id="form1" runat="server">
       <div class="auto-style1">
            ...
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" Font-Size="X-Large" ForeColor="Red" NavigateUrl="~/Default3.aspx">Continue to Order</asp:HyperLink>
            <br />
            <br />
            <br />
            ...
            <br />
            <br />
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" EmptyDataText="No Product available in Cart.Empty Cart" ForeColor="#333333" OnRowDeleting="GridView1_RowDeleting" HorizontalAlign="Center">
